...
function CollectionsList({ collectionNames, onCreate, onManage }: { collectionNames: string[]; onCreate: () => void; onManage: (collectionName: string) => void }) {
  return (
    <>
        ...
        {collectionNames.map((collectionName: string) => (
          <div className="flex justify-between items-center border-b py-4 px-8">
            ...
            <div className="flex gap-3">
              <Button onClick={onCreate} className="text-green-600" variant="outline">
                + New
              </Button>
