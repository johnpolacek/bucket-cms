...
function CollectionsIntro({ onCreateCollection }: { onCreateCollection: () => void }) {
  return (
    <>
      ...
      <Button onClick={onCreateCollection} size="lg" className="text-xl h-auto py-4">
      ...
      <div className="bg-white p-12 rounded-lg shadow-md max-w-3xl mx-auto mt-16">
        ...
        <ul className="list-disc pl-5 opacity-60">
          ...
          <li className="mb-3">
            <strong>Purpose:</strong> Collections can serve various purposes. For instance, an "Article" collection might combine text blocks, images, and videos to form a blog post. In contrast, a
            "Brand Page" collection could comprise brand headers, product galleries, and promotional videos.
          </li>
          <li>
