...
const GithubLink = () => {
  return (
    <div className="pr-4">
      <a href="https://github.com/johnpolacek/bucket-cms" target="_blank" className="opacity-70 hover:opacity-90 transition-all">
        <svg className="w-8 h-8 -mt-2" fill="currentColor" aria-label="Github" viewBox="0 0 24 24">
